...
public class ECLLayouts {
    ...
    private static final String			Layout_QueryGlobalTemp = "RECORD UNSIGNED5 encounter_num; UNSIGNED5 patient_num; UNSIGNED5 instance_num; STRING50 concept_cd; TIMESTAMP start_date; STRING50 provider_id; INTEGER8 panel_count; UNSIGNED5 fact_count; UNSIGNED5 fact_panels; END;";
    ...
    private static final String			Layout_MasterQueryGlobalTemp = "RECORD UNSIGNED5 encouter_num; UNSIGNED5 patient_num; UNSIGNED5 instance_num; STRING50 concept_cd; TIMESTAMP start_date; STRING50 provider_id; STRING50 master_id; UNSIGNED5 level_no; TIMESTAMP temporal_start_date; TIMESTAMP temporal_end_date; END;";
